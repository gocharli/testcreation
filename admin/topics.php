								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Topics List</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Topics List</a>
											</li>
										</ul>
									</div>
								</div>
                                            ...
                                            <div class="card-block table-border-style">
												<div class="table-responsive">
													<table class="table table-styling">
                                                        ...
                                                        <tbody>
                                                            <?php
																$topic_info = get_table_data('tbl_topics', 'id !="" AND created_by = "'.$_SESSION['user_login'].'" ' ,'category_id ASC');
																if($topic_info!='')
																{
																	$sr = "0";
																	foreach($topic_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td><a href="edit_topic?id=<?php echo $value->id;?>" title="Edit Type"><i class="fa fa-edit"></i></a></td>
																		</tr>
																		<?php
																	}
																}
