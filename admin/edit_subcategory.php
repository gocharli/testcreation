								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Edit Sub Category</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item"><a href="subcategory">Subcategories</a></li>
											<li class="breadcrumb-item">
												<a href="javascript:;">Edit Sub Category</a>
											</li>
										</ul>
									</div>
								</div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select name="maincategory" class="form-control">
																		...
																		<?php
																			$category_info = get_table_data('tbl_category', 'id = "'.$parent_id.'" AND status = "Active" ');
																			if($category_info!='')
																			{
																				foreach($category_info as $key => $value)
																				{
																					?>
																					<option <?php if($parent_id == $value->id){ echo "selected"; }?> value="<?php echo $value->id;?>"><?php echo $value->category_name;?></option>
																					<?php
																				}
																			}
																		?>
			...
			$.confirm({
				...
				content: function (){
					...
					return $.ajax({
						...
						dataType: 'json',
						data:frm.serialize()+"&id=<?php echo $_REQUEST['id'];?>&submit=editsubcategory",
						method: 'post'
