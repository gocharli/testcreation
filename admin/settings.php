								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Settings List</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Settings List</a>
											</li>
										</ul>
									</div>
								</div>
                                            ...
                                            <div class="card-block table-border-style">
												<div class="table-responsive">
													<table class="table table-styling">
                                                        ...
                                                        <tbody>
                                                            <?php
																$setting_info = get_table_data('tbl_settings', 'id !="" ' ,'id ASC');
																if($setting_info!='')
																{
																	$sr = "0";
																	foreach($setting_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td><a href="edit_setting?id=<?php echo $value->id;?>" title="Edit Setting"><i class="fa fa-edit"></i></a></td>
																		</tr>
																		<?php
																	}
																}
