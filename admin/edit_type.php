<?php 
	...
	$type_info = get_table_data('tbl_types', 'id="'.$_REQUEST['id'].'" ');
	if($type_info!='')
	{
													...
													<div class="card-block">
                                                        <form id="main" method="post" action="javascript:;">															
                                                                    ...
                                                                    <select name="subcategory" class="form-control">
																		...
																		<?php
																			...
																			if($category_info!='')
																			{
																				...
																				{
																					?>
																					<option <?php if($subcategory_id == $value->id){ echo "selected"; } ?> value="<?php echo $value->id;?>"><?php echo $value->category_name;?></option>
																					<?php
																				}
																			}
																		?>
															...
															<div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="typeName" id="typeName" placeholder="Type Name" value="<?php echo $type_name;?>" required>
                                                                </div>
                                                            </div>
															<div class="form-group row">
			...
			$.confirm({
				...
				content: function (){
					...
					return $.ajax({
						...
						dataType: 'json',
						data:frm.serialize()+"&id=<?php echo $_REQUEST['id'];?>&submit=edittype",
						method: 'post'
