								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Add New Type</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Add New Type</a>
											</li>
										</ul>
									</div>
								</div>
													...
													<div class="card-block">
                                                        <form id="main" method="post" action="javascript:;">															
															...
															<div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="typeName" id="typeName" placeholder="Type Name" required>
                                                                </div>
                                                            </div>
															<div class="form-group row">
			...
			$.confirm({
				...
				content: function (){
					...
					return $.ajax({
						...
						dataType: 'json',
						data:frm.serialize()+ "&submit=addtype",
						method: 'post'
