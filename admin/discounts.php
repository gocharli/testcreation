								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Discounts List</h4>
										</div>
										<ul class="breadcrumb">
                                            ...
                                            <div class="card-block table-border-style">
												<div class="table-responsive">
													<table class="table table-styling">
                                                        ...
                                                        <tbody>
                                                            <?php
																$discount_info = get_table_data('tbl_discounts', 'id !="" ' ,'id ASC');
																if($discount_info!='')
																{
																	$sr = "0";
																	foreach($discount_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td><a href="edit_discount?id=<?php echo $value->id;?>" title="Edit Setting"><i class="fa fa-edit"></i></a></td>
																		</tr>
																		<?php
																	}
																}
