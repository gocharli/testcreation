<?php 
	...
	$package_info = get_table_data('tbl_packages', 'id="'.$_REQUEST['id'].'" ');
	if($package_info!='')
	{
								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Edit Package</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Edit Package</a>
											</li>
										</ul>
									</div>
								</div>
                                                ...
                                                <div class="card">
													<div class="card-block">
                                                        <form id="main" method="post" action="javascript:;">															
                                                            ...
                                                            <input name="submit" type="hidden" value="editpackage" />
															...
															<div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input name="price" type="text" id="price" class="form-control" value="<?php echo $price;?>" >
                                                                </div>
                                                            </div>
															<div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Duration</label>
                                                                <div class="col-sm-10">
                                                                    <input name="duration" type="text" id="duration" class="form-control" value="<?php echo $duration;?>" >
                                                                </div>
                                                            </div>
															<div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Description</label>
                                                                <div class="col-sm-10">
                                                                    <textarea name="packageDescription" id="packageDescription"><?php echo $description;?></textarea>
                                                                </div>
                                                            </div>
															<div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10 form-radio">																	
																	<div class="radio radio-inline">
																		<label>
																			<input name="type" type="radio" value="New" <?php if($type == "New"){ echo "checked"; }?> >
                                                                            <i class="helper"></i>New
																		</label>
																	</div>
																	<div class="radio radio-inline">
																		<label>
																			<input name="type" type="radio" value="Renewals" <?php if($type == "Renewals"){ echo "checked"; }?>>
