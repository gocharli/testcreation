                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h4 class="m-b-10">Add New Blog</h4>
                                        </div>
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="javascript:;">Add New Blog</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="javascript:;">                                                            
                                                            <input name="submit" type="hidden" value="addblog" />
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input name="blogTitle" type="text" id="blogTitle" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Description</label>
                                                                <div class="col-sm-10">
                                                                    <textarea name="blogDescription" id="blogDescription" class="form-control"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
