																...
																if($question_info!='')
																{
																	...
																	foreach($question_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td>
																				<a href="javascript:;" onclick="copy_question('<?php echo $value->id;?>')" title="Question Copy"><i class="fa fa-copy"></i></a>
...
function copy_question(id){

	if(confirm("Copy this question! Are you sure?")){
		window.location = 'duplicate_question?id='+id;
	}
