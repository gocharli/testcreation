													...
													<div class="card-block">
                                                        <form id="main" method="post" action="javascript:;">															
															...
															<div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Enter valid e-mail address" value="<?php echo $email_id?>" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
																	...
																	<button type="button" class="btn"><a href="profile">Cancel</a></button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
			...
			$.confirm({
				...
				content: function (){
					...
					return $.ajax({
						...
						dataType: 'json',
						data:frm.serialize()+"&id=<?php echo $_SESSION['user_login'];?>&submit=Editadmin",
						method: 'post'
