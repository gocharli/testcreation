															...
															<?php
																	...
																	<div class="form-group row">
																		...
																		<div class="col-sm-10">
																			<div class="checkbox-color checkbox-primary">
																				<input name="questionType[]" id="checkbox18" type="checkbox" value="Live" checked>
																				<label for="checkbox18">Live</label>
																			</div>
																			<div class="checkbox-color checkbox-primary">
																				<input name="questionType[]" id="checkbox19" type="checkbox" value="Demo" checked>
																...
																else
																{
																	...
																	<div class="form-group row">
																		...
																		<div class="col-sm-10">
																			<div class="checkbox-color checkbox-primary">
																				<input name="questionType[]" id="checkbox18" type="checkbox" value="Live" <?php if($question_type[0] == "Live"){ echo "checked";} ?> >
																				<label for="checkbox18">Live</label>
																			</div>
																			<div class="checkbox-color checkbox-primary">
																				<input name="questionType[]" id="checkbox19" type="checkbox" value="Demo" <?php if($question_type[0] == "Demo"){ echo "checked";} ?>>
																				<label for="checkbox19">Demo</label>
																			</div>
																		</div>
																	</div>
