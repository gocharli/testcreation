<?php 
	...
	$topic_info = get_table_data('tbl_topics', 'id="'.$_REQUEST['id'].'" ');
	if($topic_info!='')
	{
								...
								<div class="row align-items-center">
									<div class="col-md-8">
										...
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Edit Topic</a>
											</li>
										</ul>
									</div>
								</div>
                                                ...
                                                <div class="card">
													<div class="card-block">
                                                        <form id="main" method="post" action="javascript:;">															
															...
															<div id="hideType" class="form-group row">
															...
															<div id="showType" class="form-group row" style="display:none;"></div>
															<div id="hideSubject" class="form-group row">
                                                                    ...
                                                                    <select name="subject" id="subject" class="form-control">
																		...
																		<?php
																			...
																			if($subject_info!='')
																			{
																				...
																				{
																					?>
																					<option <?php if($subject_id == $value->id){ echo "selected"; }; ?> value="<?php echo $value->id;?>"><?php echo $value->subject_name;?></option>
																					<?php
																				}
																			}
																		?>
															...
															<div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="topicName" id="topicName" placeholder="Topic Name" value="<?php echo $topic_name;?>" required>
                                                                </div>
                                                            </div>
															<div class="form-group row">
	...
	function get_type(c)
	{
		...
		}).done(function(response)
		{
			...
			else if(response.code==1)
			{
				...
				$('#hideType').hide();
				$('#hideSubject').hide();
				$('#showType').html(response.message);
			}
		}).responseText;
	}
			...
			$.confirm({
				...
				content: function (){
					...
					return $.ajax({
						url: "../include/post_func.php",
						dataType: 'json',
						data:frm.serialize()+"&id=<?php echo $_REQUEST['id'];?>&submit=edittopic",
						method: 'post'
					}).done(function (response){
						self.close();
						if(response.code==0)
