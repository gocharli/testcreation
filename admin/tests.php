								...
								<div class="row align-items-center">
									<div class="col-md-8">
										...
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Tests List</a>
											</li>
										</ul>
									</div>
								</div>
                                            ...
                                            <div class="card-block table-border-style">
												<div class="table-responsive">
													<table class="table table-styling">
                                                        ...
                                                        <tbody>
                                                            <?php
																$test_info = get_table_data('tbl_quick_test', 'id !="" ' ,'id ASC');
																if($test_info!='')
																{
																	$sr = "0";
																	foreach($test_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td><?php if($value->test_title == "") echo 'Untitled'; else echo $value->test_title;?></td>
																			<td><?php echo $functions->get_user_name($value->user_id);?> (<?php echo $value->user_type;?>)</td>
																			<td><?php echo $value->ip_address;?></td>
																			<td><?php echo $functions->get_category_name($value->category_id);?></td>																			
																			<td><?php echo $functions->get_type_name($value->type_id);?></td>
																			<td><?php echo date('d-m-Y', strtotime($value->created_date));?></td>
																			<td><a href="edit_test?id=<?php echo $value->id; ?>" > <i class="fa fa-edit"></i> </a> </td>
																		</tr>
																		<?php
																	}
																}
