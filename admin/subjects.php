								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Subjects List</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Subjects List</a>
											</li>
										</ul>
									</div>
								</div>
                                            ...
                                            <div class="card-block table-border-style">
												<div class="table-responsive">
													<table class="table table-styling">
                                                        ...
                                                        <tbody>
                                                            <?php
																$subject_info = get_table_data('tbl_subjects', 'id !="" AND created_by = "'.$_SESSION['user_login'].'" ' ,'category_id ASC');
																if($subject_info!='')
																{
																	$sr = "0";
																	foreach($subject_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td><a href="edit_subject?id=<?php echo $value->id;?>" title="Edit Type"><i class="fa fa-edit"></i></a></td>
																		</tr>
																		<?php
																	}
																}
