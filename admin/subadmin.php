								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Subadmin List</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Subadmin List</a>
											</li>
										</ul>
									</div>
								</div>
                                            ...
                                            <div class="card-block table-border-style">
												<div class="table-responsive">
													<table class="table table-styling">
                                                        ...
                                                        <tbody>
                                                            <?php
																$subadmin_info = get_table_data('tbl_admin', 'id !="" AND type!="admin" ' ,'id ASC');
																if($subadmin_info!='')
																{
																	$sr = "0";
																	foreach($subadmin_info as $key => $value)
																	{
																		...
																		<tr>
																			...
																			<td><a href="edit_subadmin?id=<?php echo $value->id;?>" title="Edit Subadmin"><i class="fa fa-edit"></i></a></td>
																		</tr>
																		<?php
																	}
																}
