...
<body class="fix-header fix-sidebar card-no-border">
	...
	<?php 
		$optoinId = "";
		$test_id = "";
		$strQry = "SELECT tbl_2.*, tbl_1.is_bookmark, tbl_1.test_id, tbl_1.user_answer, tbl_1.solve_time FROM tbl_quick_user_test tbl_1 LEFT JOIN tbl_questions tbl_2 ON tbl_1.question_id = tbl_2.id WHERE tbl_1.id != '' AND tbl_1.test_id = '".$_REQUEST['id']."' ";
							...
							<div id="display-detail" style="display:none">
								<div class="table-content mt-5 col-md-8">
									<table class="table table-bordered text-center">
										<tbody>
											<tr>
												<td style="background-color: #c6d8ec; color: #000;">Status: <div id="correct-answer"></div></td>
									...
									<div class="col-md-12 custom-tabs">
										...
										<div class="tab-content tabcontent-border">
											...
											<div class="tab-pane active" id="home" role="tabpanel">
												<div class="p-20">
													<span style="word-break:break-all"><?php echo $ads[0];?></span>
												</div>
											</div>
											<?php } ?>
											<?php if($row->video != '') { ?>
