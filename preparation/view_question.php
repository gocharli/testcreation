...
<body class="fix-header fix-sidebar card-no-border">
	...
	<?php 
		$optoinId = "";
		$test_id = "";
		$strQry = "SELECT tbl_2.*, tbl_1.is_bookmark, tbl_1.test_id, tbl_1.user_answer, tbl_1.answer, tbl_1.solve_time FROM tbl_quick_user_test tbl_1 LEFT JOIN tbl_questions tbl_2 ON tbl_1.question_id = tbl_2.id WHERE tbl_1.id != '' AND tbl_1.test_id = '".$_REQUEST['id']."' AND tbl_1.question_id = '".$_REQUEST['qid']."' ";
									...
									<ul class="navbar-nav mr-auto mt-md-0">
										<li class="nav-link">
											...
											<?php } else {?>
												<span id="bookmark_no">
													<a href="javascript:;" id="bookmarked" style="color: #FFF;">
														<img src="../static/img/mark_for_review_icon_notext.png" id="bookmark" width="25" height="25" alt=""/>
													</a>
												</span>
											<?php }?>
										</li>
										<li class="nav-link">
											<a data-toggle="modal" data-target=".bd-example-modal-lg" href="#" style="color: #FFF;">
											<img src="../static/img/reference_sheet.png" width="25" height="25" alt=""/> </a>
										</li>
										<?php if($row->hint!=""){ ?>
										<li class="nav-link">
							...
							<div id="display-detail" style="display:none">
								<div class="table-content mt-5 col-md-8">
									<table class="table table-bordered text-center">
										<tbody>
											<tr>
												<td style="background-color: #c6d8ec; color: #000;">Status: <div id="correct-answer1111"> <?php echo $answer; ?></div></td>
									...
									<div class="col-md-12 custom-tabs">
										...
										<div class="tab-content tabcontent-border">
											<div class="tab-pane active" id="home" role="tabpanel">
												<div class="p-20">
													<span style="word-break:break-all"><?php echo $row->explation;?></span>
												</div>
											</div>
							...
							<div class="row">
								...
								<?php
									...
									<div class="col-xs-6 col-sm-6 text-right">
										<?php if($page > 1) {?>
											<a href='start_test?id=<?php echo $_REQUEST['id'];?>&page=<?php echo $page-1;?>&previous=yes' style="color: #FFF; padding-right: 20px;">
												<img src="../static/img/previous_icon_notext.png" width="25" height="25" alt=""/> Previous
											</a>
										<?php } ?>
										<?php if($total_pages > $page) {?>
										<a href='start_test?id=<?php echo $_REQUEST['id'];?>&page=<?php echo $page+1;?>&next=yes' style="color: #FFF;">
	...
	<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<img src="../static/img/equations.png" width="100%" alt=""/> 
				</div>
			</div>
		</div>
	</div>
	...
	<?php
		if($previous == "yes" && $userAnswer != "0")
		{
			...
			<script>
				...
				var realvalue = <?php echo $optoinId;?>;
	...
	<script>
		jQuery(document).ready(function()
		{
			...
			$( "#answer_submit" ).click("submit",function( event )
			{
				...
				var radioValue = $("input[name='radio1']:checked").val();
				var serializedData = "tid="+testId+"&rid="+radioValue+"&opId="+opId+"&qId="+qId+"&stime="+stime+"&submit=answer",
