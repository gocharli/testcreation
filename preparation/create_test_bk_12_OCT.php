...
<!-- <input type="hidden" id="test_mode" value="Tutor" /> -->
															...
															<div class="row demo-swtich border-bottom">
																...
																<div class="col-md-12 mt-2 demo-checkbox">
																	<input name="difficulty_level[]" type="checkbox" class="filled-in chk-col-cyan" id="basic_checkbox_<?php echo $id;?>_<?php echo $typeId[$j];?>_1" value="Low" checked <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																	...
																	<input name="difficulty_level[]" type="checkbox" id="basic_checkbox_<?php echo $id;?>_<?php echo $typeId[$j];?>_2" class="filled-in chk-col-cyan" value="Medium" checked <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																	...
																	<input name="difficulty_level[]" type="checkbox" id="basic_checkbox_<?php echo $id;?>_<?php echo $typeId[$j];?>_3" class="filled-in chk-col-cyan" value="High" checked <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																		...
																		foreach($subject_info as $key => $val)
																		{
																			...
																			if($displaySubject!="0")
																			{
																				...
																				<div class="col-md-6 mt-2 demo-checkbox">
																					<div class="col-md-12">
																						<input name="subject_name[]" type="checkbox" class="filled-in chk-col-cyan <?php echo preg_replace('/[^a-z]/i', '', $val->subject_name); ?>" onclick="update_topic_check_by_class('<?php echo preg_replace('/[^a-z]/i', '', $val->subject_name); ?>')" id="basic_checkbox_<?php echo $id;?>_<?php echo $typeId[$j];?>_<?php echo $key;?>_1" checked="" <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																						...
																						<div class="col-md-12">
																							<?php
																								...
																								if($topic_info!="")
																								{
																									...
																									{
																										?>
																										<input name="topic_name[]" type="checkbox" class="filled-in chk-col-cyan <?php echo preg_replace('/[^a-z]/i', '', $val->subject_name).'_topic';?>" value="<?php echo $row->id ?>" id="basic_checkbox__<?php echo $id;?>_<?php echo $typeId[$j];?>_<?php echo $keys;?>_<?php echo str_replace(' ', '', $row->topic_name);?>" checked="" <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																	...
																	if($subject_info!="")
																	{
																		foreach($subject_info as $key => $val)
																		{
																			...
																			if($displaySubject!="0")
																			{
																				...
																				<div class="col-md-6 mt-2 demo-checkbox">
																					<div class="col-md-12">
																						<input type="checkbox" class="filled-in chk-col-cyan <?php echo preg_replace('/[^a-z]/i', '', $val->subject_name);?>" onclick="update_topic_check_by_class('<?php echo preg_replace('/[^a-z]/i', '', $val->subject_name); ?>')" id="basic_checkbox_<?php echo $id;?>_<?php echo $typeId[$j];?>_<?php echo $key;?>_1" checked="" <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																						<label for="basic_checkbox_<?php echo $id;?>_<?php echo $typeId[$j];?>_<?php echo $key;?>_1"><?php echo $val->subject_name?> <span class="badge badge-secondary"><?php echo $functions->get_subject_total_ques($id, $typeId[$j], $val->id);?></span></label>
																						<div class="col-md-12">
																							<?php
																								$topic_info = get_table_data('tbl_topics', 'id!="" AND category_id="'.$id.'" AND type_id = "'.$typeId[$j].'" AND subject_id = "'.$val->id.'" AND status = "Active" ');
																								if($topic_info!="")
																								{
																									...
																									{
																										?>
																										<input type="checkbox" class="filled-in chk-col-cyan <?php echo preg_replace('/[^a-z]/i', '', $val->subject_name).'_topic';?>" value="<?php echo $row->id ?>" id="basic_checkbox__<?php echo $id;?>_<?php echo $typeId[$j];?>_<?php echo $keys;?>_<?php echo str_replace(' ', '', $row->topic_name);?>" checked="" <?php if($is_paid_user <= 0) echo 'disabled'; ?>>
																										<label for="basic_checkbox__<?php echo $id;?>_<?php echo $typeId[$j];?>_<?php echo $keys;?>_<?php echo str_replace(' ', '', $row->topic_name);?>" style="width: 100%;"><?php echo $row->topic_name;?> <span class="badge badge-secondary"><?php echo $functions->get_topic_total_ques($id, $typeId[$j], $val->id, $row->id);?></span></label>
																										<?php
																									}
																								}
							...
							$.confirm({
								...
								content: function (){
									...
									return $.ajax({
										url: "../include/post_func.php",
										dataType: 'json',
										data:serializeFrom+"&categoryId="+<?php echo $id;?>+"&typeId="+tid+"&test_mode="+test_mode+"&submit=GenerateTest",
										method: 'post'
									}).done(function (response){
										self.close();
										if(response.code==0)
