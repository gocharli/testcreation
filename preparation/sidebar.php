		...
		<div class="scroll-sidebar">
			...
			<nav class="sidebar-nav"> 
				<ul id="sidebarnav">   	
					...
					<li><a class="waves-effect waves-dark" href="create_test?id=<?php if($id > 0) echo $id; else if(!empty($_REQUEST['id'])) echo $_REQUEST['id']; else $_SESSION['categoryType']; ?>" aria-expanded="false"><i class="fa fa-edit"></i><span class="hide-menu">CREATE TEST</span></a></li>	
					...
					<li><a class="waves-effect waves-dark" href="help" aria-expanded="false"><i class="fa fa-question-circle"></i><span class="hide-menu">HELP</span></a></li>
