              ...
              <?php
                ...
                if ($category_info != '') {
                  foreach ($category_info as $key => $value) {
                    ?>
                    <div class="col-md-2">
                      <h4 style="color: #fda100;"><?php echo htmlspecialchars($value->category_name); ?></h4>
                      <?php
                        ...
                        if ($subcategory_info != '') {
                          ...
                          ?>
                          <ul>
                            <li><a href="desctiption?id=<?php echo (int)$val->id; ?>" style="color: #FFF;"><?php echo htmlspecialchars($val->category_name); ?></a></li>
                          </ul>
                          <?php
                          }
                        }
      ...
      <div class="container">
        <div class="tab-style-1">
          <ul class="nav nav-fill" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="<?php echo ($cid === '') ? 'active' : ''; ?>" id="profile-tab" data-toggle="tab" href="#profilea" role="tab" aria-controls="profilea" aria-selected="<?php echo ($cid === '') ? 'true' : 'false'; ?>">Profile</a>
            </li>
            <li class="nav-item">
              <a class="<?php echo ($cid !== '') ? 'active' : ''; ?>" id="home-tab" data-toggle="tab" href="#homea" role="tab" aria-controls="homea" aria-selected="<?php echo ($cid !== '') ? 'true' : 'false'; ?>">Subscriptions</a>
            </li>						
            <li class="nav-item">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <!-- SUBSCRIPTIONS TAB -->
            <div class="tab-pane p-40px-t sm-p-40px-t fade <?php echo ($cid !== '') ? 'show active' : ''; ?>" id="homea" role="tabpanel" aria-labelledby="home-tab">
              <?php
                // ***** FIXED: fetch DISTINCT category_id for this student (no GROUP BY *)
                $subscription_info = [];
                if (isset($conn) && $conn instanceof mysqli) {
                  $stmt = $conn->prepare("SELECT DISTINCT category_id FROM tbl_subscribe_package WHERE student_id = ?");
                  $stmt->bind_param("i", $_SESSION['student_login']);
                  $stmt->execute();
                  $res = $stmt->get_result();
                  while ($row = $res->fetch_assoc()) {
                    $subscription_info[] = (object)$row; // keep object style
                  }
                  $stmt->close();
                }
                ...
                if (!empty($subscription_info)) {
                  ...
                  foreach ($subscription_info as $key => $value) {
                    ?>
                    <!--user-->
                    <h4><?php echo htmlspecialchars($functions->get_category_name($value->category_id)); ?> Qbank</h4>
                    <?php 
                      // include student filter; keep expiry filter; remove GROUP BY
                      $package_info = get_table_data(
                        'tbl_subscribe_package',
                        'id!="" 
                         AND student_id = "'.$_SESSION['student_login'].'"
                         AND category_id = "'.$value->category_id.'"
                          ...
                          <div class="alert alert-info" style="box-shadow: 0px 0px 15px rgba(0,0,0,0.1);">
                            <div class="row">
                              <div class="col-md-8 pull-left">
                                <h5><?php echo htmlspecialchars($functions->get_package_info($val->package_id)); ?> Package </h5>
                              ...
                              <div class="col-md-4">
                                ...
                                <?php } else { ?> 
                                  <p class="m-0px">
                                    <a href="javascript:;" style="color: white; margin-top: 20px;" class="btn btn-danger" onclick="cancel_subscription('<?php echo (int)$val->id; ?>')">Cancel Subscription</a>
                                  </p>
                                <?php } ?>
                              </div>
                              <!--col md 4-->
...
function cancel_subscription(id){
  if(confirm("Cancel subscription! Are you sure?")){
    ...
    request.done(function(){
      window.location = 'memberarea';
            ...
            ?>
            <div class="tab-pane p-40px-t sm-p-40px-t fade <?php echo ($cid === '') ? 'show active' : ''; ?>" id="profilea" role="tabpanel" aria-labelledby="profile-tab">
              <div class="col-md-12">
                      ...
                      <div class="form">
                        <div class="row">
                          <div class="col-md-6 pull-left">
                            <div class="headit"><h4>User Information</h4></div>
                            <form class="login-form" id="l">
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <input name="firstName" type="text" class="form-field" value="<?php echo htmlspecialchars($firstname); ?>" placeholder="First Name" required />
                                </div>
                                <div class="col-md-6 pull-left">
                                  <input name="lastName" type="text" class="form-field" value="<?php echo htmlspecialchars($lastname); ?>" placeholder="Last Name" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-12">
                                  <input name="primaryAddress" type="text" class="form-field" value="<?php echo htmlspecialchars($primaryaddress); ?>" placeholder="Address (House Number & Street Name)" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <input name="secondaryAddress" type="text" class="form-field" value="<?php echo htmlspecialchars($secondaryaddress); ?>" placeholder="Address2" />
                                </div>
                                <div class="col-md-6 pull-left">
                                  <input name="city" type="text" class="form-field" value="<?php echo htmlspecialchars($city); ?>" placeholder="City" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                    ...
                                    <?php
                                      ...
                                      if ($country_info != '') {
                                        foreach ($country_info as $key => $value) {
                                          ?>
                                          <option <?php if ($value->id == $country) { echo "selected"; } ?> value="<?php echo (int)$value->id; ?>"><?php echo htmlspecialchars($value->name); ?></option>
                                          <?php
                                        }
                                      }
                                    ?>
                                ...
                                <div class="col-md-6 pull-left">
                                  <input name="state" type="text" class="form-field" placeholder="State" value="<?php echo htmlspecialchars($state); ?>" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <input name="zipCode" type="text" class="form-field" value="<?php echo htmlspecialchars($zipcode); ?>" placeholder="Zip" required />
                                </div>
                                <div class="col-md-6 pull-left">
                                  <input name="phoneNo" type="text" class="form-field mob_no" placeholder="Phone" value="<?php echo htmlspecialchars($phone); ?>" data-mask="999-999-9999" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-12">
                                  <input name="userEmail" type="text" class="form-field" placeholder="Email ID (Username)" value="<?php echo htmlspecialchars($username); ?>" required />
                                </div>
                              </div>
                              <?php
                                ...
                                if ($usertype_info != '') {
                                  foreach ($usertype_info as $key => $value) {
                                    ...
                                    <div class="form-check form-check-inline">
                                      <input name="userType" class="form-check-input" type="radio" id="inlineCheckbox<?php echo $uid; ?>" <?php if ($uid == $usertype) { echo "checked"; } ?> value="<?php echo $uid; ?>" required />
                                      <label class="form-check-label" for="inlineCheckbox<?php echo $uid; ?>"><?php echo htmlspecialchars($value->usertype); ?></label>
                                    </div>
                                    <?php
                                  }
                                }
                          ...
                          <div class="col-md-6 pull-right">
                            <div class="headit"><h4>Change Password</h4></div>
                            ...
                            <form class="login-form" id="m">
                              <div class="headit"><h4>Security Questions</h4></div>
                              <div class="row">
                                <div class="col-md-12">
            ...
            <?php
              ...
              if ($billing_info != '') {
                ...
                $first_name = $last_name = $address1 = $address2 = $city = $bCountry = $state = $zip_code = $phone_no = '';
              }
            ?>
                      ...
                      <div class="form">
                        <div class="row">
                          <div class="col-md-5 pull-left">
                            <div class="headit"><h4>Billing Information</h4></div>
                            <form class="login-form" id="b">
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <input name="bfName" type="text" class="form-field" value="<?php echo htmlspecialchars($first_name); ?>" placeholder="First Name" required />
                                </div>
                                <div class="col-md-6 pull-left">
                                  <input name="blName" type="text" class="form-field" value="<?php echo htmlspecialchars($last_name); ?>" placeholder="Last Name" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-12">
                                  <input name="bAddress1" type="text" class="form-field" value="<?php echo htmlspecialchars($address1); ?>" placeholder="Address (House Number & Street Name)" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <input name="bAddress2" type="text" class="form-field" value="<?php echo htmlspecialchars($address2); ?>"  placeholder="Address 2" />
                                </div>
                                <div class="col-md-6 pull-left">
                                  <input name="bCity" type="text" class="form-field" value="<?php echo htmlspecialchars($city); ?>" placeholder="City" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <select name="bCountry" class="form-control" required>
                                    ...
                                    <?php
                                      ...
                                      if ($country_info != '') {
                                        foreach ($country_info as $key => $value) {
                                          ?>
                                          <option <?php if ($value->id == $bCountry) { echo "selected"; } ?> value="<?php echo (int)$value->id; ?>"><?php echo htmlspecialchars($value->name); ?></option>
                                          <?php
                                        }
                                      }
                                    ?>
                                ...
                                <div class="col-md-6 pull-left">
                                  <input name="bState" type="text" class="form-field" placeholder="State" value="<?php echo htmlspecialchars($state); ?>" required />
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-6 pull-left">
                                  <input name="bZipcode" type="text" class="form-field" value="<?php echo htmlspecialchars($zip_code); ?>" placeholder="Zip Code" required />
                                </div>
                                <div class="col-md-6 pull-left">
                                  <input name="bPhoneno" type="text" class="form-field mob_no" placeholder="Phone" value="<?php echo htmlspecialchars($phone_no); ?>" data-mask="999-999-9999" required />
                                </div>
                              </div>
                          ...
                          <div class="col-md-7 pull-right">
                            ...
                            <?php
                              ...
                              if ($payment_info != '') {
                                    ...
                                    <?php
                                      foreach ($payment_info as $key => $value) {
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo htmlspecialchars($value->txn_id); ?></td>
                                          <td><?php echo htmlspecialchars($durations); ?></td>
                                          <td>$ <?php echo number_format((float)$value->paid_amount, 2); ?></td>
                                        </tr>
                                        <?php
                                      }
                                    ?>
                                ...
                                ?>
                                <div class="alert alert-warning">There are no payments.</div>
                                <?php
                              }
                            ?>
                          </div>
    ...
    $(document).ready(function(){
      $("#inlineCheckbox1").click(function(){
        $.ajax({
          ...
          if(response.code==1){
            $('#display_country').show().html(response.message);
          }
        });
      });

      $("#inlineCheckbox2, #inlineCheckbox3").click(function(){
        $.ajax({
          url: "include/post_func.php",
          type: "post",
          dataType: "json",
      ...
      $.confirm({
        ...
        content: function (){
          ...
          return $.ajax({
            url: "include/post_func.php",
            dataType: 'json',
            data: profileForm + "&id=" + <?php echo (int)$_SESSION['student_login']; ?> + "&submit=ProfileUpdate",
            method: 'post'
          }).done(function (response){
            self.close();
            $.confirm({
              title: response.code==1 ? 'Success!' : 'Error!',
              icon: response.code==1 ? 'fa fa-success' : 'fa fa-warning',
              closeIcon: true,
              content: response.message,
              type: response.code==1 ? 'green' : 'red',
        ...
        $.confirm({
          ...
          content: function (){
            ...
            return $.ajax({
              url: "include/post_func.php",
              dataType: 'json',
              data: passwordForm + "&id=" + <?php echo (int)$_SESSION['student_login']; ?> + "&submit=PasswordUpdate",
              method: 'post'
            }).done(function (response){
              self.close();
              $.confirm({
      ...
      $.confirm({
        ...
        content: function (){
          ...
          return $.ajax({
            url: "include/post_func.php",
            dataType: 'json',
            data: answerForm + "&id=" + <?php echo (int)$_SESSION['student_login']; ?> + "&submit=AnswerUpdate",
            method: 'post'
          }).done(function (response){
            self.close();
            $.confirm({
      ...
      $.confirm({
        ...
        content: function (){
          ...
          return $.ajax({
            url: "include/post_func.php",
            dataType: 'json',
            data: billingForm + "&id=" + <?php echo (int)$_SESSION['student_login']; ?> + "&submit=BillingUpdate",
            method: 'post'
          }).done(function (response){
            self.close();
            $.confirm({
  ...
  <script>
    ...
    theToggle && (theToggle.onclick = function() {
      toggleClass(this, 'on');
      return false;
    });
  </script>
